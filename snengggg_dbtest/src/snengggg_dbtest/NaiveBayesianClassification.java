...
public class NaiveBayesianClassification {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*String[] dataSet = {
        			"movie|theater,actor,moviestar",
                "movie|action,comedy,hollywood",
                "travel|fun,nature,airplain,europe",
                "travel|hotel,photo,airplain,passport",
                "travel|fly,trip,dream,money,action",
                "fashion|clothes,hair,model",
                "movie|love,love,action,fun",
                "travel|fly,fast,shoot,love,action"
        };*/
        String[] dataSet = {
    				"movie|theater,actor,moviestar",
    				"movie|action,comedy,hollywood",
        ...
        //-- 테스트 데이터
        String[] words = {"airplain", "fun", "action"};
